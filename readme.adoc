image:https://github.com/st-tu-dresden-praktikum/swt21w08/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt21w08/actions"]
...
The lottery application is a project to bootstrap the Java project in the Software Engineering lab.
